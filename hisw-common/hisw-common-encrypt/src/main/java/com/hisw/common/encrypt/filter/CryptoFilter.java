...
import com.hisw.common.core.constant.HttpStatus;
...
public class CryptoFilter implements Filter {
    ...
    private ApiEncrypt getApiEncryptAnnotation(HttpServletRequest servletRequest) {
        // 通过 HttpServletRequest 获取当前处理的 HandlerMethod
        Object handler = servletRequest.getAttribute(HandlerMapping.BEST_MATCHING_HANDLER_ATTRIBUTE);
